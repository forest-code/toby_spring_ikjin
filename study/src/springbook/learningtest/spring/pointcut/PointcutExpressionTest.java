...
public class PointcutExpressionTest {
	...
	public void targetClassPointMatches(String expression, boolean... expected) throws Exception {
	...
	public void pointcut() throws Exception {
		targetClassPointMatches("execution(* *(..))", true, true, true, true, true, true);
	}
}
